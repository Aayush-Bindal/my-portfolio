...
export type SpiralAnimationHandle = {
  playExit: (onComplete: () => void) => void
}

export const SpiralAnimation = forwardRef<SpiralAnimationHandle>(function SpiralAnimation(_, ref) {
  ...
  useImperativeHandle(ref, () => ({
    playExit: (onComplete: () => void) => {
      animationRef.current?.playExit(onComplete)
    },
  }))
